...
- Follow this [link](https://ohmyz.sh/)

### bash : bash-it

- Follow this [link](https://github.com/Bash-it/bash-it)

### Custom Aliases

Append those lines to `~/.bashrc` or `~/.zshrc`
...
alias gaa='git add -A'
alias gcam="git add -A && git commit -v -am"
